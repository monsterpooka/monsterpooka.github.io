...
(function (Map) {
    ...
    var App = (function () {
        ...
        App.prototype.init = function () {
            ...
            var quanginhMap = new GoogleMap(21.06205, 106.6025812, 18, "map-quangninh");
            quanginhMap.setOptions({
                scrollwheel: false
            });
            quanginhMap.setHue(hue);
            quanginhMap.setMarker("Huy Hoang Event");
            quanginhMap.display();

            var hanoiMap = new GoogleMap(21.3228396, 105.605608, 15, "map-hanoi");
            hanoiMap.setOptions({
                scrollwheel: false,
                zoomControlOptions: {
            ...
            hanoiMap.setHue(hue);
            hanoiMap.setMarker("Com Pho 2 Restaurent");
            hanoiMap.display();
        };
        return App;
    })();
